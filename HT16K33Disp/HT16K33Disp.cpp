...
//------------------------------------------------------------
void HT16K33Disp::dispInit(byte address, byte brightLevel)
{
...
//------------------------------------------------------------
void HT16K33Disp::dispChar(byte address, byte digit, char c1)
{
    uint16_t c2; 
    c2 = convert(c1);
    //------------------------------
...
//------------------------------------------------------------
void HT16K33Disp::dispString(byte address, String text1)
{
...
//------------------------------------------------------------
void HT16K33Disp::dispNum(byte address, byte digit, int n)
{
    switch(n)
    {
      case 0: dispChar(address, digit, '0'); break;
      case 1: dispChar(address, digit, '1'); break;
      case 2: dispChar(address, digit, '2'); break;
      case 3: dispChar(address, digit, '3'); break;
      case 4: dispChar(address, digit, '4'); break;
      case 5: dispChar(address, digit, '5'); break;
      case 6: dispChar(address, digit, '6'); break;
      case 7: dispChar(address, digit, '7'); break;
      case 8: dispChar(address, digit, '8'); break;
      case 9: dispChar(address, digit, '9');
    }
}
//------------------------------------------------------------
void HT16K33Disp::dispNumdp(byte address, byte digit, int n)
{
    uint16_t c2;   
    c2 = convertdp(n);
    //------------------------------
...
//------------------------------------------------------------
void HT16K33Disp::dispClear(byte address)
{
    for(byte i=0; i<=3; i++) dispChar(0x70, i, ' ');
}
//------------------------------------------------------------
